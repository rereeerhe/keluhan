      ...
      <div class="card card-info card-outline">
        <div class="card-header">
          <div class="card-tools">
            <a href='create' class='btn btn-success'> Tambah Data <i class='fas fa-plus-square'></i></a>
          </div>
        </div>
        ...
        <div class='card-body'>
          <table class='table table-bordered'>
            ...
            <tr>
              ...
              <td>{{ $item -> alamat }}</td>
              <th>
              <a href="edit/{{$item->id}}" class='btn btn-warning'>Edit</a> <a href='delete/{{$item->id}}' class='btn btn-danger'>Delete</a>
              </th>
            </tr>
            @endforeach
          </table>
