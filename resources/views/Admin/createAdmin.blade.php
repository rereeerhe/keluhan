        ...
        <div class='card-body'>
          <form action='simpanAdmin' method='post'>
            ...
            <div class ='form-group'>
              <input type='text' id='nama' name='nama' class='form-control' placeholder='Nama Admin'>
            </div>
            <div class ='form-group'>
            ...
            <div class ='form-group'>
              <textarea id='alamatA' name='alamat' class='form-control' placeholder='Alamat'></textarea>
            </div>
            <div class ='form-group'>
