  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="dataKeluhan" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Data Keluhan</p>
                </a>
              </li>
      ...
      <div class="card card-info card-outline">
        <div class="card-header">
          <div class="card-tools">
            <a href='createKeluhan' class='btn btn-success'> Tambah Data <i class='fas fa-plus-square'></i></a>
          </div>
        </div>
        ...
        <div class='card-body'>
          <table class='table table-bordered'>
            ...
            <tr>
              ...
              <td>{{ $item -> status }}</td>
              <th>
              <a href='editKeluhan/{{$item->id}}' class='btn btn-warning'>Edit</a> <a href='deleteKeluhan/{{$item->id}}' class='btn btn-danger'>Delete</a>
              </th>
            </tr>
            @endforeach
          </table>
