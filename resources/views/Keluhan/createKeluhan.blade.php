      ...
      <div class="card card-info card-outline">
        ...
        <div class='card-body'>
          <form action='simpanKeluhan' method='post'>
            ...
            <div class ='form-group'>
              <input type='text' id='nama_keluhan' name='nama_keluhan' class='form-control' placeholder='Nama Keluhan' >
            </div>
            <div class ='form-group'>
              <input type='text' id='deskripsi' name='dekripsi' class='form-control' placeholder='Deskripsi'>
            </div>
            <div class ='form-group'>
              <!-- <input type='' id='alamat' name='alamat' class='form-control' placeholder='Alamat'> -->
              <select name= 'status'>
